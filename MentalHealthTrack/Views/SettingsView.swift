...
struct SettingsView: View {
    ...
    private var notificationSettingsView: some View {
        VStack(spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text(formatNotificationPeriod(start: notificationStartTime, end: notificationEndTime))
                    .font(.caption)
    ...
    private func generateNotificationSchedule(startTime: Date, endTime: Date, interval: Int) -> [Date] {
        var schedule: [Date] = []
        let calendar = Calendar.current
